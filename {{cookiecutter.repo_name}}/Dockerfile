...
COPY ./server /app
COPY ./deploy/script/compose/django/pip.conf /root/.pip/pip.conf
# COPY ./server/requirements.txt /requirements.txt
COPY ./deploy/script/compose/django/gunicorn.sh /gunicorn.sh
COPY ./deploy/script/compose/django/entrypoint.sh /entrypoint.sh
COPY ./deploy/script/compose/django/sources.list /etc/apt/sources.list
